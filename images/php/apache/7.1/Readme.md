...
The available virtual host files are listed [here](https://github.com/lethak-docker/webplatform/tree/master/build_files/apache/vhosts).
...
You can run the container with the docker run command :
   ...
   ``` sh
    docker run -p 80:80 -p 88:88 -p 82:82 lethak/apache:7.1
   ```
...
Ex : 
   ...
   ``` sh
    docker run -p 80:80 -p 88:88 -p 82:82 -v "005-myvhost.conf:/etc/apache2/sites-available/005-myvhost.conf" lethak/apache:7.1
   ```
...
Ex : 
   ...
   ``` sh
    docker run -p 80:80 -p 88:88 -p 82:82 -v "21-my_custom_php_conf.ini:/etc/php/7.1/apache2/conf.d/21-my_custom_php_conf.ini" lethak/apache:7.1
   ```
...
Ex : 
   ...
   ``` sh
    docker run -p 80:80 -p 88:88 -p 82:82 -v "startup.sh:/run/startup.sh" lethak/apache:7.1
   ```
